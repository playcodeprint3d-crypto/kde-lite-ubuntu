...
<div class="masterstudy-account">
	...
	<div class="masterstudy-account-container">
		<?php
		if ( function_exists( 'playcode_codespaces_render_aistudio_dashboard' ) ) {
			echo playcode_codespaces_render_aistudio_dashboard();
		} else {
			echo '<div style="background:#FFF; border:2px solid #001F4A; padding:20px; font-weight:800; color:#001F4A;">Google AI Studio</div>';
		}
		?>
	</div>
</div>
